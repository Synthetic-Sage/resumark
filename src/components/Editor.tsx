      ...
      <div className="bg-slate-950 rounded-3xl p-6 mb-8 text-white shadow-xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="flex flex-col gap-1.5">
              {[
                ...
                <button
                  ...
                  className={`text-left px-3 py-2 text-xs font-bold rounded-xl transition-all ${
                    activeTemplate === t.id ? 'bg-white text-slate-950' : 'hover:bg-slate-800 text-slate-400'
                  }`}
                >
                  {t.name}
                </button>
          ...
          <div>
            ...
            <div className="flex flex-col gap-1.5">
              {[
                { id: 'font-sans', name: 'Inter (Modern)' },
                ...
                <button
                  ...
                  className={`text-left px-3 py-2 text-xs font-bold rounded-xl transition-all ${
                    activeFont === f.id ? 'bg-white text-slate-950' : 'hover:bg-slate-800 text-slate-400'
                  }`}
                >
                  {f.name}
                </button>
          ...
          <div>
            ...
            <div className="flex flex-wrap gap-2.5">
              {[
                ...
                { id: 'text-rose-600', bg: 'bg-rose-600' },
                { id: 'text-amber-600', bg: 'bg-amber-600' },
              ].map((c) => (
                <button
                  key={c.id}
                  onClick={() => setColor(c.id)}
                  className={`w-8 h-8 rounded-full border-2 transition-all ${c.bg} ${activeColor === c.id ? 'border-white scale-110 shadow-[0_0_15px_rgba(255,255,255,0.3)]' : 'border-transparent opacity-50 hover:opacity-100'}`}
